...
* **(2021/12)** SPVNAS wins the second place in NuScenes LiDAR Panoptic Segmentation Challenge.
* **(2021/5)** SPVNAS wins the first place in NuScenes LiDAR Semantic Segmentation Challenge.
